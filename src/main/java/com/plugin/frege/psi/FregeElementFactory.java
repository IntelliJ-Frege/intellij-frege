...
public class FregeElementFactory {
    ...
    public static @NotNull FregeAnnotation createAnnotation(Project project, String name, String type) {
        String fakeFunction = fakeProgram + name + " :: " + type;
        return createElement(project, fakeFunction, FregeAnnotation.class);
    }
    ...
    // TODO
    public static @NotNull PsiElement createNewLine(Project project) {
        String fakeNewLine = fakeProgram + "\ny b = undefined\n";
        PsiElement tmp = createElement(project, fakeNewLine, FregeTopDecl.class);
        return tmp.getPrevSibling();
    }
}
